...
try:
    ...
    print('When you want to use github login, please see mysite/github_settings-dist.py')

# try:
#     from . import social_login_settings
#     SOCIAL_AUTH_FACEBOOK_KEY = social_login_settings.SOCIAL_AUTH_FACEBOOK_KEY
#     SOCIAL_AUTH_FACEBOOK_SECRET = social_login_settings.SOCIAL_AUTH_FACEBOOK_SECRET
# except:
#     print('When you want to use facebook login, please see mysite/social_login_settings.py')
