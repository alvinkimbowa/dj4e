...
# from autos.forms import MakeForm # Used when we don't use the CreateView etc
...
# The hard way of writing the views.

# This is when you hard write the code. There is simpler way with django.
...
#         form.save()
#         return redirect(self.success_url)
# That was the hard way of doing stuff.
